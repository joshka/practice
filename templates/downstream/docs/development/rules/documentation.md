...
- `DOCS-AVOID-GENERATED-PROSE-TELLS`: Avoid generated-prose tells because generated prose often
  sounds polished while hiding that it did not learn the project voice.
